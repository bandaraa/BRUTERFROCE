...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" shehan lahiru  [FR15632]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" ................."$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.Husltar] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%Km.S%] [ 😇😇]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 0774593440"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" shehan9909@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" FACEBOOK B.F. PHP        "$i"|"$i"    |"$cy" H"$i" |"
echo $i"|"$me" 2"$i" |"$cy" FACEBOOK B.F 2           "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 3"$i" |"$cy" FACEBOOK B.F PHP2.       "$i"|"$i"    |"$cy" C"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB FBF        "$i"|"$i"    |"$cy" K"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" F"$i" |"
echo $i"|"$me" 6"$i" |"$cy" BRUTEFORCE FB ( root )   "$i"|"$i"    |"$cy" I"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 7"$i" |"$cy" HACK  CLONING FACEBOOK   "$i"|"$i"    ─────"
echo $i"|"$me" 8"$i" |"$cy" HACK T¹ GUARD FACEBOOK   "$i"|"$i"    |"$cy" I"$i" |"
echo $i"|"$me" 9"$i" |"$cy" HACK T2 FACEBOOK WORK    "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me"10"$i" |"$cy" AUTO REACTION FACEBOOK   "$i"|"$i"    |"$cy" F"$i" |"
echo $i"|"$me"11"$i" |"$cy" INFORMATION FACEBOOK     "$i"|"$i"    |"$cy" O"$i" |"
echo $i"|"$me"12"$i" |"$cy" BOT CCFBR FACEBOOK       "$i"|"$i"    |"$cy" 🤐"$i" |"
echo $i"|"$me"13"$i" |"$cy" AUTOLIKE FACEBOOK        "$i"|"$i"    |"$cy" C"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" O"$i" |"
...
sleep 2
echo $cy"TerMinal Expired"
sleep 2
echo $i"        "
sleep 2
echo $ku"WhatsApp :"$i" 0774593440"
echo $ku"Facebook :"$i" DOPE_SAKIN"
sleep 2
echo $pur">> Thanks all. good bay<<"
exit
fi
